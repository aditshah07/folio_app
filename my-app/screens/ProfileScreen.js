...
export default class ProfileScreen extends React.Component {
        ...
        // This method runs when the component is ready so we make API calls to get user information and loans to render on the screen
        componentDidMount = () => {
            // Creating a header for the API call using token when we got during login
            var fetchOptions = {
                method: 'GET',
                headers: {
                    'X-Okapi-Tenant': 'diku',
            ...
            // Get the user id using the okapi token
            axios(url, fetchOptions)
                    ...
                    axios(urlForUserInfo, fetchOptions)
                        .then((responseJson) => {
                            if (responseJson.status === 200) {
                                ...
                                // Checking whether the json the properties otherwise it will throw an error can't access values of undefined
                ...
                // Fetch the loans of the user for the user information we have there's no loans so included mock data from loan.json
                .then(() => {
                    ...
                    axios(url, fetchOptions)
                        .then((responseJson) => {
                            ...
                            // For each book we request for the title using book id
                            if (responseJson.status === 200) {
                                console.log("success");
                            } else {
                                Alert.alert("Something went wrong");
                    ...
                    // We get the array of loans, we don't get title information of the books so with the book id we fetch the title
                    .then((state) => {
                    ...
                    // Fetch address type id because it changes every night so we have to make a call for it every time otherwise we won't be able to update the value
                    .then((state) => {
                            var state1 = state;
                        ...
                        // For each book in the loans we request for url for cover image from google which is supplied as uri for images
                        .then((state) => {
                            // Using google key so they can track the App which is using it and what kind of data they're accessing
                            ...
                            if (urls.length) {
                                // For each title we fetch cover of the book from the google API
                                return Promise.all(
        ...
        // Updating the state when the values gets changed in the input for the fieldfield 
        ...
        // When update for personal information is clicked this method updates the value in folio
        ...
        // When update for extended information is clicked this method updates the value in folio
        ...
        // When update for contact information is clicked this method updates the value in folio
        ...
        // setting iscollapsed for personal information when the the drop down is clicked
        setIsCollapsed() {
        ...
        // setting iscollapsed for contact information when the the drop down is clicked
        ...
        // setting iscollapsed for extended information when the the drop down is clicked
        ...
        // setting iscollapsed for loans when the the drop down is clicked
        setIsCollapsedLoan() {
